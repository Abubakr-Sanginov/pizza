...
export default function AdminLoginPage() {
  ...
  return (
    <Container className="flex items-center justify-center min-h-[calc(100vh-100px)] py-20">
      <div className="w-full max-w-[450px] bg-white p-10 rounded-3xl border shadow-2xl">
        <div className="text-center mb-8">
           <Title text="Вход в админ-панель" size="lg" className="font-bold mb-2" />
           <p className="text-gray-400">Для доступа к управлению необходимо авторизоваться под учетной записью администратора</p>
        </div>
        ...
        <div className="mt-8 pt-8 border-t text-center">
          <Link href="/">
            <Button variant="ghost" className="text-gray-400 hover:text-primary gap-2">
              <ArrowLeft size={16} />
