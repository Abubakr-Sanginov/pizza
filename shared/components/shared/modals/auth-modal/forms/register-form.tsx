      ...
      <div className="flex flex-col gap-6 text-center py-4">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-gray-400 text-sm">
            ...
            <span className="text-black font-semibold break-all">{email}</span>
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
           <input 
             autoFocus
             className="w-full h-14 text-center text-3xl tracking-[0.2em] font-bold border-2 border-gray-100 rounded-xl focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all px-2"
             placeholder="000000"
             maxLength={6}
